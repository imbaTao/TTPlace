...
@interface HTSVIndefiniteAnimatedView ()

@property (nonatomic, strong) CAShapeLayer *indefiniteAnimatedLayer;

@end

@implementation HTSVIndefiniteAnimatedView
...
- (CAShapeLayer*)indefiniteAnimatedLayer {
    if(!_indefiniteAnimatedLayer) {
        ...
        maskLayer.contents = (__bridge id)[[UIImage imageNamed:@"HTSVIndefiniteAnimatedViewWhiteCircle"] CGImage];
