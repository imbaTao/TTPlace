//
//  HTCommonTableViewController.swift
//  HTSwiftLearn
//
...
class HTTableViewController<T: HTTableViewViewModel>: HTCommonViewController {
    /**
     包含一个默认的vm
     vm.可以控制tableView的样式
     管理data
    ...
    lazy var tableView: HTCommonTableView = {
        var tableView = HTCommonTableView.init()
        return tableView
    }()
}
