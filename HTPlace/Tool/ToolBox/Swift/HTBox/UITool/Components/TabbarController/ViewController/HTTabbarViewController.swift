...
//    let vm = HTTabbarViewControllerViewModel()
    ...
    func setupTabbar() {
        ...
        // rx绑定数据源,直接显示
        tabbarConfiguration.items.bind(to: htTabbar.bar.rx.items(cellIdentifier: "HTTabbarItem", cellType: HTTabbarItem.self)) { [weak self] (collectionView, itemModel, cell) in
