...
//        navigationController?.pushViewController(vc, animated: true)
        ...
        HTAlert.show(maxSize: .zero,title: "标题", message: "内容", buttonTitles: ["取消","完成"], click: { (index) in
