...
//    
//    private var itemsArray = [TTAddPhotoBannerCell]()
//    
//    // 默认添加图片的加号
//    lazy var defaultAddItem: TTAddPhotoBannerCell = {
//        var defaultAddItem = TTAddPhotoBannerCell.init(image: R.image.ttAddPhotoBanner_defaultAddIcon()!)
...
//            let item = TTAddPhotoBannerCell.init(image: bannerModel.image)
//            // addAction event
