...
class  HTTableViewViewModel: NSObject {
    // 数据源
    ...
    var style: UITableView.Style = .grouped
     ...
     // 默认的单类型cell名称
     var cellSingelClassName: String = "HTTableViewCell"
     
     // cell的类型数组
     var allCellClassNames: [String] = ["HTTableViewCell"]
...
//protocol HTTableViewViewModelDelegate {
...
//extension HTTableViewViewModelDelegate {
//    // 子类复写，初始化之后的操作
//    func vmSetup() {
//
//    }
...
//class HTTableViewModel: HTTableViewViewModelDelegate {
//
//    var pageSize = 10;
//
//    var pageIndex = 10;
