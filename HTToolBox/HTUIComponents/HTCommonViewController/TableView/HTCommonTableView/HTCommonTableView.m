...
- (instancetype)initWithStyle:(UITableViewStyle)style cellClassNames:(NSArray *)cellClassNames delegateTarget:(id)target {
     self = [self initWithFrame:CGRectZero style:UITableViewStylePlain cellClassNames:cellClassNames delegateTarget:target];
    if (self) {
