...
extension UIImage {
    class func testImage() -> UIImage {
        return UIImage.name("TTTest")
    }
    class func testImage1() -> UIImage {
        return UIImage.name("TTTest1")
    }
    ...
    class func gradientImage(
        position: TTGradientImagePositon = .leftToRight, startPoint: CGPoint? = nil,
        endPoint: CGPoint? = nil, colors: [UIColor]?, size: CGSize, radius: CGFloat = 0.0
    ) -> UIImage? {
    ...
    open class func gradientImage(
        colors: [UIColor]?, size: CGSize, radius: CGFloat, opacity: CGFloat
    ) -> UIImage? {
