...
class TTTableViewController: TTViewController, UITableViewDelegate, UIScrollViewDelegate {
    ...
    lazy var tableView: TTTableView = {
        let tableView = TTTableView.init(style: .grouped)
...
//            viewModel.headerLoading.asObservable().bind(to: isHeaderLoading).disposed(
//                by: rx.disposeBag)
//            viewModel.footerLoading.asObservable().bind(to: isFooterLoading).disposed(
//                by: rx.disposeBag)
...
extension TTTableViewController {
    ...
    func buttonImage(forEmptyDataSet scrollView: UIScrollView!, for state: UIControl.State)
        -> UIImage!
    {
        //        switch TTNetManager.shared.netStatus {
        //        case .none:
    ...
    func buttonTitle(forEmptyDataSet scrollView: UIScrollView!, for state: UIControl.State)
        -> NSAttributedString!
    {
        let content: String = ""
        //        switch TTNetManager.shared.netStatus {
