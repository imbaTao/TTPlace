//
//  TTSVIndefiniteAnimatedView.m
//  SVProgressHUD, https://github.com/SVProgressHUD/SVProgressHUD
//
//  Copyright (c) 2014-2018 Guillaume Campagna. All rights reserved.
//

#import "TTSVIndefiniteAnimatedView.h"
@interface TTSVIndefiniteAnimatedView ()

@property (nonatomic, strong) CAShapeLayer *indefiniteAnimatedLayer;

@end

@implementation TTSVIndefiniteAnimatedView
...
- (CAShapeLayer*)indefiniteAnimatedLayer {
    if(!_indefiniteAnimatedLayer) {
        ...
        maskLayer.contents = (__bridge id)[[UIImage imageNamed:@"TTSVIndefiniteAnimatedViewWhiteCircle"] CGImage];
