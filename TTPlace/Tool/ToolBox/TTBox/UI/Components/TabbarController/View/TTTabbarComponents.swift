...
class TTTabbarItem: TTCollectionViewCell {
    ...
    lazy var tuberView: TTTbbarItemTuberView = {
        ...
        var tuberView = TTTbbarItemTuberView.init(drawSourceRect: CGRect.init(x: 0, y: 0, width: self.bounds.width, height: 12), drawFillColor: .white, drawBorderWidth: 0.5)
