...
//#import "UIColor+TTColorExtentsion.h"
//
...
//    TTCommonCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"TTCommonCollectionViewCell" forIndexPath:indexPath];
